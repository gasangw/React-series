...
function MyButton() {
  const ALL_EXERCISES_AVAILABLE = ["Home", "exercise 1", "exercise 2", "exercise 3", "exercise 4","exercise 5", "exercise 6", "exercise 7", "exercise 8", "exercise 9"]
 
  return (
<div className='grid'>
  <div className='flex mx-auto mt-16'>
    {ALL_EXERCISES_AVAILABLE.map(element => {
      return (
      <ul key={uuid_v4()}>
