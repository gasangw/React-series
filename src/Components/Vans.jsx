        ...
        {vans && vans.map(van => {
          return (
            <div key={van.id} className="grid">
               ...
               <button className="border-none outline-none font-medium px-8 py-2 rounded-lg w-fit text-white" style={{backgroundColor: van.type == 'simple'? '#E17654' : van.type == 'rugged'? '#115E59': '#161616'}}>{van.type}</button>
            </div>
          )
        })}
       </div>
